...
## DONE:
- (caltech_to_tfrecords.py, caltech_common.py) -> Can create tfrecord files, but still need to make appropriate config (Person_full and Person_occluded) 
- This is for legit, so make new files and edit these for conversion to tfrecords for the BS strategy
